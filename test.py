...
def get_args_parser():
    ...
    # * Knowledge
    parser.add_argument('--know_cate_num', default=3, type=int, help='The number of knowledge categories.')
    parser.add_argument('--know_cate_len', default=4, type=int,
                        help='The maximum input sequence length of a knowledge category.')
    parser.add_argument('--know_retrieval_results',
                        default='knowledge_retrieval/data/knowledge_for_model_training.json')
    parser.add_argument('--only_segment', action='store_true',
                        help='Just to obtain segments, not full modal test.')
    ...
    parser.add_argument('--pseudo_strategy_loss_coef', default=10, type=float)
    parser.add_argument('--diversity_loss_coef', default=0.125, type=float)

    # dataset parameters
    parser.add_argument('--data_root', default='./data/')
    parser.add_argument('--split_root', default='./data/annotations/')
    parser.add_argument('--dataset', default='kbref')
